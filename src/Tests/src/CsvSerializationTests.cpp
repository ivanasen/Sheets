...
TEST_CASE("SerializeCsv", "[CsvTableFormatting]") {
    ...
    table.setCellValue(0, 0, "Pesho's \"");
    table.setCellValue(1, 0, "12");
    table.setCellValue(2, 1, "12.3455645");
    table.setCellValue(2, 2, "= R2C1 + 232.35 * R3C2 - 354");
...
TEST_CASE("DeserializeCsv", "[CsvTableFormatting]") {
    ...
    REQUIRE(table.getCellDisplayValue(1, 2) == "3.14");
    REQUIRE(table.getCellDisplayValue(2, 0) == "3232");
    REQUIRE(table.getCellDisplayValue(2, 1) == "Hello World!");
    REQUIRE(table.getCellDisplayValue(3, 0) == "Pesho, Gosho\" sdsd!?  ");
    std::string formulaResult = table.getCellDisplayValue(2, 2);
